...
const employees: Employee[] = [{
  ...
  Extension: '5467',
  Photo: 'src/assets/images/employees/06.png',
  ...
  Extension: '3457',
  Photo: 'src/assets/images/employees/02.png',
  ...
  Extension: '3355',
  Photo: 'src/assets/images/employees/09.png',
  ...
  Position: 'Sales Representative',
  TitleOfCourtesy: 'Mrs.',
  BirthDate: '1977-09-19T00:00:00.000Z',
  ...
  Extension: '5176',
  Photo: 'src/assets/images/employees/04.png',
  Notes: 'Margaret holds a BA in English literature from Concordia College (1998) and an MA from the American Institute of Culinary Arts (1999).  She was assigned to the London office temporarily from July through November 2012.',
  ReportsTo: 2,
}, {
  EmployeeID: 5,
  ...
  Extension: '3453',
  Photo: 'src/assets/images/employees/05.png',
  ...
  Extension: '428',
  Photo: 'src/assets/images/employees/01.png',
  ...
  Extension: '465',
  Photo: 'src/assets/images/employees/07.png',
  Notes: 'Robert King served in the Peace Corps and traveled extensively before completing his degree in English at the University of Michigan in 2002, then he joined the company as a sales representative.  After completing a course entitled "Selling in Europe," he was transferred to the London office in March 2013.',
  ReportsTo: 5,
}, {
  EmployeeID: 8,
  ...
  Extension: '2344',
  Photo: 'src/assets/images/employees/08.png',
  ...
  Extension: '452',
  Photo: 'src/assets/images/employees/03.png',
